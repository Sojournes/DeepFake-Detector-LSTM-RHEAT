...
class HaarWaveletTransform(nn.Module):
    ...
    def forward(self, x):
        ...
        for c in range(channels):
            ...
            # Note: This hybrid approach (tensor->numpy->tensor) might break gradients if not handled carefully
            # But the original code had this:
...
class EATFormer(nn.Module):
    def __init__(self, in_dim=3, num_classes=1000,
        ...
        self.embed_dim = embed_dims[-1] # Add this for reset_classifier
...
class DualModel(nn.Module):
    def __init__(self, pretrained_eatformer=False, pretrained_resnet=True):
        ...
        # Note: Using eatformer_base configuration as default
        self.eat_model = EATFormer(
